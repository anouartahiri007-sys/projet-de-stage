        ...
        <div className="lg:col-span-4 space-y-6">
           <div className="gov-card p-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="relative inline-block">
                  <img 
                    src={user?.role === 'veterinarian' ? 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&w=150&q=80' : 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=150&q=80'} 
                    alt={user?.name} 
                ...
                <h2 className="text-xl font-bold text-gray-800 mt-6">{user?.name || 'د. أحمد الببيطري'}</h2>
                <p className="text-xs font-black text-emerald-600 uppercase tracking-widest mt-1">طبيب بيطري - مصلحة الصحة الحيوانية</p>
              ...
              <div className="mt-8 pt-8 border-t border-gray-100 grid grid-cols-2 gap-4">
                 <div className="text-right">
                    ...
                    <p className="text-sm font-bold text-gray-700">#{user?.id}VET</p>
                 </div>
           ...
           <div className="gov-card p-6">
              ...
              <div className="flex flex-wrap gap-2">
                 ...
                 <span className="px-2.5 py-1 bg-emerald-50 text-emerald-700 rounded-lg text-[10px] font-black uppercase border border-emerald-100">إصدار شهادات</span>
                 <span className="px-2.5 py-1 bg-emerald-50 text-emerald-700 rounded-lg text-[10px] font-black uppercase border border-emerald-100">إدارة الأوبئة</span>
              </div>
           </div>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                 <div className="flex items-start gap-4">
                    ...
                    <div>
                       ...
                       <p className="font-bold text-gray-700">{user?.email || 'vet@example.com'}</p>
                    </div>
                 </div>
                 <div className="flex items-start gap-4">
                 ...
                 <div className="flex items-start gap-4">
                    ...
                    <div>
                       ...
                       <p className="font-bold text-gray-700">الصحة العامة البيطرية</p>
                    </div>
                 </div>
                 <div className="flex items-start gap-4">
           ...
           <div className="gov-card p-8">
              ...
              <div className="relative border-r-2 border-emerald-100 pr-8 mr-4 space-y-8">
                 <div className="relative">
                    ...
                    <h4 className="font-bold text-gray-800 text-sm">طبيب بيطري من الدرجة الأولى</h4>
                    <p className="text-xs text-gray-500 mt-1">جماعة مدينة المستقبل | 2021 - الحالي</p>
                 </div>
                 <div className="relative">
                    <div className="absolute -right-[41px] top-0 w-5 h-5 rounded-full border-4 border-white bg-gray-300 shadow-sm"></div>
                    <h4 className="font-bold text-gray-800 text-sm">طبيب بيطري ممارس</h4>
                    <p className="text-xs text-gray-500 mt-1">وزارة الفلاحة (المديرية الإقليمية) | 2015 - 2021</p>
                 </div>
              </div>
           </div>
        </div>
