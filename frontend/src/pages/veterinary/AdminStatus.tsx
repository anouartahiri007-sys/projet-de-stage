import { Shield, Award, Calendar, Briefcase, ChevronRight, Info, UserCheck } from 'lucide-react';
        ...
        <div className="lg:col-span-8 space-y-6">
           <div className="gov-card p-8 relative overflow-hidden">
              ...
              <div className="flex items-center gap-6 mb-10">
                 ...
                 <div>
                    <h2 className="text-xl font-black text-gray-800 tracking-tight">طبيب بيطري - الدرجة الأولى</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                 {[
                    { label: 'السلم', value: 'السلم 11', icon: <Award className="text-blue-500" /> },
                    { label: 'الرتبة', value: 'الرتبة 07', icon: <Briefcase className="text-purple-500" /> },
           ...
           <div className="gov-card p-8">
              ...
              <div className="space-y-6">
                 {[
                    ...
                    { title: 'ترقية في الرتبة (الرتبة 07)', date: '01/01/2021', status: 'منجزة', color: 'text-emerald-600 bg-emerald-50' },
                    { title: 'الترسيم في الوظيفة العمومية', date: '12/05/2018', status: 'منجزة', color: 'text-emerald-600 bg-emerald-50' },
                    { title: 'الالتحاق بالجماعة (متدرب)', date: '12/05/2017', status: 'منجزة', color: 'text-emerald-600 bg-emerald-50' },
                 ].map((item, i) => (
        ...
        <div className="lg:col-span-4 space-y-6">
           <div className="gov-card p-6 bg-emerald-900 text-white shadow-xl shadow-emerald-900/20">
              ...
              <p className="text-xs text-emerald-100/80 leading-relaxed font-medium mb-6">
                أنت حالياً في الرتبة 7 من السلم 11. الترقية القادمة للرتبة 8 مبرمجة تلقائياً في يناير 2025 بناءً على الأقدمية.
              </p>
