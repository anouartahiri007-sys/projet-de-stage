import { Wallet, TrendingUp, Download, Eye, ArrowUpRight, DollarSign, CreditCard, Landmark, FileText } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-slide-up pb-12">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 font-heading">الأجر والتعويضات</h1>
          <p className="text-sm text-gray-500 mt-1">كشف الرواتب والتعويضات الشهرية - الفضاء الشخصي</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="gov-card p-6 bg-gradient-to-br from-emerald-600 to-emerald-800 text-white relative overflow-hidden group">
           ...
           <div className="relative z-10">
              ...
              <h2 className="text-3xl font-black mb-6">11,150.00 <span className="text-sm opacity-60">درهم</span></h2>
              <div className="flex items-center gap-2 text-[10px] font-bold bg-white/20 w-fit px-2 py-1 rounded-lg backdrop-blur-sm">
                 <TrendingUp size={12} />
                 +240.00 درهم عن الشهر الماضي
              </div>
           </div>
        </div>
        ...
        <div className="gov-card p-6 flex items-center gap-5">
           ...
           <div>
              ...
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">CIH Bank - ****9854</p>
           </div>
        </div>
        ...
        <div className="gov-card p-6 flex items-center gap-5">
           ...
           <div>
              ...
              <h3 className="text-sm font-bold text-gray-800">1,500.00 درهم</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 gov-card overflow-hidden">
           <div className="p-6 border-b border-gray-100 bg-gray-50/30 flex items-center justify-between">
              <h3 className="font-bold text-gray-800 text-sm">سجل الرواتب الأخيرة</h3>
           ...
           <div className="overflow-x-auto">
              <table className="w-full text-right border-collapse">
                 ...
                 <tbody className="divide-y divide-gray-50">
                    {[
                       { month: 'ماي 2024', gross: '14,500', ded: '3,350', net: '11,150' },
                       { month: 'أبريل 2024', gross: '13,200', ded: '3,350', net: '9,850' },
                       { month: 'مارس 2024', gross: '13,200', ded: '3,350', net: '9,850' },
                    ].map((row, i) => (
        ...
        <div className="lg:col-span-4 gov-card p-6 h-fit">
           ...
           <div className="space-y-6">
              {[
                 { label: 'التعويض عن التدرج', value: '1,200.00', color: 'bg-emerald-500' },
                 { label: 'التعويض عن الأعباء', value: '450.00', color: 'bg-blue-500' },
                 { label: 'تعويضات بيطرية خاصة', value: '850.00', color: 'bg-amber-500' },
              ].map((item, i) => (
                 <div key={i} className="space-y-2">
                    <div className="flex justify-between text-[10px] font-black text-gray-400 uppercase tracking-widest">
                       <span>{item.label}</span>
                       <span className="text-gray-700 font-bold">{item.value} درهم</span>
                    </div>
           ...
           <div className="mt-8 p-4 bg-emerald-50 rounded-2xl border border-emerald-100 flex items-start gap-3">
              <div className="mt-1 text-emerald-600"><FileText size={16} /></div>
              <p className="text-[10px] font-bold text-emerald-800 leading-relaxed">
                ملاحظة: تم صرف تعويض استثنائي عن التنقلات الميدانية لشهر ماي بقيمة 1,300 درهم.
              </p>
           </div>
        </div>
      </div>
