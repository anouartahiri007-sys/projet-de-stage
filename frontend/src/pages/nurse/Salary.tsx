import { Wallet, TrendingUp, Download, Eye, Landmark, CreditCard, FileText } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="gov-card p-6 bg-gradient-to-br from-emerald-600 to-emerald-800 text-white relative overflow-hidden group">
           ...
           <div className="relative z-10">
              ...
              <h2 className="text-3xl font-black mb-6">7,850.00 <span className="text-sm opacity-60">درهم</span></h2>
              <div className="flex items-center gap-2 text-[10px] font-bold bg-white/20 w-fit px-2 py-1 rounded-lg backdrop-blur-sm">
                 <TrendingUp size={12} />
                 +120.00 درهم عن الشهر الماضي
              </div>
           </div>
        </div>
        ...
        <div className="gov-card p-6 flex items-center gap-5">
           ...
           <div>
              ...
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">CIH Bank - ****4501</p>
           </div>
        </div>
        ...
        <div className="gov-card p-6 flex items-center gap-5">
           ...
           <div>
              ...
              <h3 className="text-sm font-bold text-gray-800">850.00 درهم</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           ...
           <div className="overflow-x-auto">
              <table className="w-full text-right border-collapse">
                 ...
                 <tbody className="divide-y divide-gray-50">
                    {[
                       { month: 'ماي 2024', gross: '10,200', ded: '2,350', net: '7,850' },
                       { month: 'أبريل 2024', gross: '10,080', ded: '2,350', net: '7,730' },
                       { month: 'مارس 2024', gross: '10,080', ded: '2,350', net: '7,730' },
                    ].map((row, i) => (
        ...
        <div className="lg:col-span-4 gov-card p-6 h-fit">
           ...
           <div className="space-y-6">
              {[
                 { label: 'التعويض عن التدرج', value: '450.00', color: 'bg-emerald-500' },
                 { label: 'التعويض عن الأعباء', value: '250.00', color: 'bg-blue-500' },
                 { label: 'تعويضات خاصة بالتمريض', value: '150.00', color: 'bg-amber-500' },
              ].map((item, i) => (
